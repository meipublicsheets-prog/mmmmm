...
const HEADERS = {
  CUSTOMER_ORDERS: ["Order_ID","Task_Number","Project","NBD","Request_Status","Stock_Status","Company","Order_Title","Deliver_To","Name","Phone_Number","Original_Order","Order_Folder","Pick_Ticket_PDF","TOC_PDF","Packing_Lists","Total_Skids","Created_TS","Created_By"],
  STOCK_TOTALS: ["SKU","FBPN","MFPN","Manufacturer","Qty_Available","Qty_In_Racking","Qty_On_Floor","Qty_Inbound_Staging","Qty_Allocated","Qty_Backordered","Qty_Shipped","Qty_Received","Qty_In_Stock","Manufacturer","Total On Hand","Total Allocated","Total Backordered","Total Shipped","Total Received"],
  ...
  SHEET70: ["Date_Received","Transaction_Type","Warehouse","Project","Push #","FBPN","Qty_Received","Customer_PO_Number"],
  ...
  TXN_RECON_20260107_082711: ["TXN_ID Reconciliation: Master_Log vs Inbound_Skids"],
  SHEET56: ["Push #"],
  SHEET53: [],
  INBOUND_QTY_AUDIT: ["Txn_ID","FBPN","Master_Log Qty_Received","Inbound_Skids Qty_on_Skid","Difference (Master - Skids)","Issue","Push #","BOL_Number","Customer_PO_Number","Project (from Skids)","Skid_IDs"],
  BIN_STOCK: ["Bin_Code","Bin_Name","Push_Number","FBPN","Manufacturer","Project","Initial_Quantity","Current_Quantity","#REF!","AUDIT NEEDED","Skid_ID","#REF!"],
  FLOOR_STOCK_LEVELS: ["Bin_Code","Bin_Name","Push_Number","FBPN","Manufacturer","Project","Initial_Quantity","Current_Quantity","#ERROR!","AUDIT NEEDED","Skid_ID","SKU"],
  SHEET69: ["Bin_Code","Bin_Name","Push_Number","FBPN","Manufacturer","Project","Initial_Quantity","Current_Quantity","Stock_Percentage","AUDIT NEEDED","Skid_ID","SKU"],
  REQUESTED_ITEMS: ["Order_ID","FBPN","Description","Qty_Requested","Stock_Status","Qty_Backordered","Qty_Allocated","Qty_Shipped","Backorder_ID","Allocation_ID","SKU"],
  PICK_LOG: ["PIK_ID","NBD","Order_Number","Task_Number","Company","Project","FBPN","Description","Qty_Requested","Qty_To_Pick","Bin_Code","Qty_Picked","Status","Picked_By","Shipped_Date","Timestamp","SKU"],
  CONSOLIDATIONSUGGESTIONS: ["SKU","FBPN","Bin_To_Empty","Qty_In_Donor_Bin","Bin_To_Fill","Original_Qty","Qty_To_Move","Final_Qty_In_Bin"],
  PICKED_ITEM_LOG: [],
  LOCATIONLOG: ["Timestamp","Action","FBPN","Manufacturer","Bin_Code","Qty_Changed","Resulting_Qty","Description","User_Email","SKU"],
  CYCLE_COUNT_BATCHES: ["Batch_ID","Zone","Created_TS","Created_By","Status","Notes"],
  CYCLE_COUNT_LINES: ["Batch_ID","Bin_Code","FBPN","SKU","Expected_Qty","Counted_Qty","Variance","Status"],
  REPLENISHMENT_TASKS: ["Task_ID","Created_TS","Priority","Source_Bin","Target_Bin","FBPN","SKU","Qty","Status","Assigned_To","Completed_TS","Notes"],
  DOCK_SCHEDULE: ["Dock_ID","Type","Date","Time","Carrier","BOL","Order_Number","Task_Number","Status","Notes"],
  RACKING_AUDIT: ["FBPN","Manufacturer","Bin_Stock_Total","Stock_Totals_Qty_In_Racking","Difference"],
  BREAKDOWN_LOG: ["Breakdown_ID","Skid_ID","Item_ID","FBPN","Qty_Before","Qty_Removed","Qty_Remaining","MasterSkid_ID","Qty_On_ChildSkid","Bin_ID_Child","Date_Broken_Down","Broken_Down_By","Notes"],
  ...
  AUDIT_TRAIL: ["Audit_ID","Timestamp","User","Action","Entity_Type","Entity_ID","Field","Old_Value","New_Value","Notes"],
  ITEM_MASTER: ["Item_ID","FBPN","Description","Asset Type","Manufacturer","Model","QR Code","Bin_Code","Stock_On_Hand"],
